...
extern touchgfx::GeneratedFont& getFont_flappybird_12_4bpp();
extern touchgfx::GeneratedFont& getFont_flappybird_43_4bpp();
extern touchgfx::GeneratedFont& getFont_flappybird_20_4bpp();

const touchgfx::Font* touchgfx_fonts[] = {
    &(getFont_arial_20_4bpp()),
    &(getFont_verdana_40_4bpp()),
    &(getFont_verdana_10_4bpp()),
    &(getFont_flappybird_12_4bpp()),
    &(getFont_flappybird_43_4bpp()),
    &(getFont_flappybird_20_4bpp())
};
...
void resetFont(touchgfx::FontId fontId)
{
    ...
    case 2:
        ...
        break;
    case 3:
        touchgfx_fonts[3] = &(getFont_flappybird_12_4bpp());
        break;
    case 4:
        touchgfx_fonts[4] = &(getFont_flappybird_43_4bpp());
        break;
    case 5:
        touchgfx_fonts[5] = &(getFont_flappybird_20_4bpp());
        break;
    }
}
} // namespace TypedTextDatabase
